...
Options:
    ...
    [extra args]      Any unrecognised arguments are forwarded directly to BEAST
                      (e.g. python benchmark.py big 1 min -beagle_GPU -beagle_double)
...
def main():
    ...
    args, extra_beast_args = parser.parse_known_args()
